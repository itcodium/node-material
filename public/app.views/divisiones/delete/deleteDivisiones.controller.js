(function () {
    ...
    angular
        .module('app')
        .controller('deleteDivisionesController', deleteDivisionesController);

    deleteDivisionesController.$inject = ['documentosSeleccionados', '$mdDialog', '$mdToast', '$scope', '$q','$http', 'Global'];
    /* @ngInject */
    function deleteDivisionesController(documentosSeleccionados, $mdDialog, $mdToast, $scope, $q, $http,Global) {
        ...
        function borrarDocumento(obj, index) {
            ...
            var req = {
                method: 'PUT',
                url: '/api/divisionesParametric/delete/',
                headers: {},
                data: obj
            }
