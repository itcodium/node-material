(function () {
  ...
  angular
    .module('app')
    .controller('DivisionesController', DivisionesController);

  DivisionesController.$inject = ['$scope', '$resource', '$filter', '$mdDialog'];
  /* @ngInject */
  function DivisionesController($scope, $resource, $filter, $mdDialog) {
    ...
    function gridDoor() {
      ...
      function getData(query) {
        $scope.promiseDocumento = $resource('/api/divisionesParametric/').query(successDivisiones).$promise;
      ...
      function add(event) {
        $mdDialog.show({
          ...
          controller: 'addDivisionesController',
          controllerAs: 'ctrl',
          focusOnOpen: false,
          targetEvent: event,
          locals: {
            scope: $scope,
            parseDivisiones: $scope.divisiones
          },
          templateUrl: 'app.views/divisiones/modal.html'
        }).then(getData);
      }
      ...
      function edit(event) {
        $mdDialog.show({
          clickOutsideToClose: true,
          controller: 'editDivisionesController',
          controllerAs: 'ctrl',
          focusOnOpen: false,
          targetEvent: event,
          locals: {
      ...
      function del(event) {
        $mdDialog.show({
          clickOutsideToClose: true,
          controller: 'deleteDivisionesController',
          controllerAs: 'ctrl',
          focusOnOpen: false,
          targetEvent: event,
          locals: { documentosSeleccionados: $scope.selected },
          templateUrl: 'app.views/divisiones/modalDelete.html'
        }).then(getData);
      }
